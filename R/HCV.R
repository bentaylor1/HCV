...
## The package \code{HCV} depends upon some other important contributions to CRAN in order to operate; their uses here are indicated:\cr\cr
...
##' @docType package
##' @name HCV-package
##' @author Paula E. Moraga-Serrano, CHICAS, Department of Medicine, Lancaster University,
##'  Benjamin M. Taylor, CHICAS, Department of Medicine, Lancaster University
##' @keywords package
##'
##'
...
## @importFrom stats vcov as.formula acf coefficients deriv dexp dist dnorm runif end fft fitted formula Gamma integrate knots lm model.matrix optim optimise poly quantile rbinom rexp rnorm runif sd start update var residuals cov
